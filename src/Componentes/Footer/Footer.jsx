            ...
            <div className={style.row}>
                ...
                <div className={style.titulos}>
                    ...
                    <div className={style.redes}>
                        <a href="https://www.facebook.com/medeatv/?locale=br_FR" target='_blank' rel="noreferrer">
                            <img src={facebook} alt="Facebook" />
                        </a>
                        <a href='https://www.instagram.com/medea_ok/' target='_blank' rel="noreferrer">
                            <img src={insta} alt="Instagram" />
                        </a>
                        <a href='https://www.tiktok.com/@medeatvhd' target='_blank' rel="noreferrer">
                        ...
                        <a href='https://www.youtube.com/@MEDEATVHD' target='_blank' rel="noreferrer">
